        ...
        <>
           <nav className="navbar navbar-expand-lg sticky-top bg-body-tertiary  ">
                <div className="container-fluid d-flex justify-content-between">
                    <a className="navbar-brand flex-shrink-2" href="#" > <span className="btn btn-primary rounded-circle fs-5 fw-bolder py-2 px-4">Blue </span><span className="text-primary fw-bold ">&nbsp;Health Labs</span></a>
                    <div className="nav_buttons">
                            <button id='nav_buttons' className="nav_button1">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-journal-check" viewBox="0 0 16 16">
                                ...
                                </svg> <span>CheckUps </span> 
                            </button>
                            <button id='nav_buttons' className="nav_button2">
                            ...
                            <button id='nav_buttons' className="nav_button3">
